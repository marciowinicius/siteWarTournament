...
<div id="LayerPop2" style="position: absolute; left: 60px; top: 40px; z-index: 5000;"><a href="?subtopic=shopsystem" target="_BLANK"><img style="width:640px; height:360px" src="../images/promo.png" class="imgBorder"></a><br><a href="javascript:void();" onClick="document.getElementById('LayerPop').style.display = 'none';document.getElementById('LayerPop2').style.display = 'none'">
