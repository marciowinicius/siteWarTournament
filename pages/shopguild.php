...
<tr bgcolor="#d4c0a1"><td>Level m&iacute;nimo:</td><td>Level 130</td></tr>

<tr bgcolor="#f1e0c6"><td>Players On-line:</td><td>10 On-line</td></tr>
<tr bgcolor="#d4c0a1"><td>IPs Diferentes:</td><td>6 IPs</td></tr>
<tr bgcolor="#f1e0c6"><td>Quantidade de pontos:</td><td>15 Pontos (cada player) para cada account</td></tr>
<tr>
																...
																<table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
																	...
																	if(count($offer_list['storage']) > 0)
																		foreach($offer_list['storage'] as $storage) {
																			...
																			<td align="center">';
																			if(!$logged) $main_content .= '<a href="http://mindfreakot.com/?subtopic=accountmanagement">Login First</a>'; else 
																				$main_content .= '
