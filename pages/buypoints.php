...
else
{
	...
	if($config['paypal_active'])
		$main_content .= '<br /><br /><div style="padding:20px 20px 20px 20px"><center><a href="?subtopic=paypal"><img src="../images/paypal.png" border="0" alt="Link to this page"></a></center></div>';
	if($config['paypal_active'])
		$main_content .= '<br /><br /><div style="padding:20px 20px 20px 20px"><center><a href="?subtopic=donate"><img src="../images/pagseguro.jpg" border="0" alt="Link to this page"></a></center></div>';
	if($config['zaypay_active'])
		$main_content .= '<br /><br /><div style="padding:20px 20px 20px 20px"><center><a href="?subtopic=pagepaygol"><img src="../images/paygol.jpg" border="0" alt="Link to this page"></a></center></div>';
	if($config['zaypay_active'])
