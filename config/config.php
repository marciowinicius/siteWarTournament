...
$config['site']['worlds'] = array(0 => 'War Tournament OT');
$towns_list[0] = array(1 => 'Yalahar', 2 => 'Carlin', 3 => 'Abdendriel', 4 => 'Kazordoon', 5 => 'Thais', 6 => 'Venore');
...
$config['site']['newchar_towns'][0] = array(1, 2, 3, 4, 5, 6);
$config['site']['max_players_per_account'] = 15;


# E-MAIL config
$config['site']['send_emails'] = 1; // is acc. maker configured to send e-mails?
$config['site']['mail_address'] = "suporte.wartournament@gmail.com"; // e-mail address
...
$config['site']['smtp_user'] = "suporte.wartournament@gmail.com"; // login
$config['site']['smtp_pass'] = "amaral11"; // password
...
$config['pagseguro']['email'] = 'marciowinicius.mw@hotmail.com';
